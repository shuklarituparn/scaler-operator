...
func (in *Namedspacename) DeepCopyInto(out *Namedspacename) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Namedspacename.
func (in *Namedspacename) DeepCopy() *Namedspacename {
	if in == nil {
		return nil
	}
	out := new(Namedspacename)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScalerSpec) DeepCopyInto(out *ScalerSpec) {
	*out = *in
	if in.Deployments != nil {
		...
		*out = make([]Namedspacename, len(*in))
		copy(*out, *in)
	}
}
